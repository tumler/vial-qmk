...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LCTL,  KC_LGUI,  KC_LALT,     LOWER,  KC_ESC,             KC_SPC,              KC_ENT,    RAISE,    KC_DOWN,    KC_UP,  KC_RIGHT
  ),

  [_LOWER] = LAYOUT_reviungdash_single(
  ...
  [_RAISE] = LAYOUT_reviungdash_single(
  ...
  [_ADJUST] = LAYOUT_reviungdash_single(
